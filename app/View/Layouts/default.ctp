...
$cakeDescription = __d('cake_dev', 'CakePHP Custom Skeleton');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="container">
		<div id="header">
		<h1><?php echo $this->Html->link($cakeDescription, 'http://bitbucket.org/gwhitcher/cakephp-custom-skeleton'); ?></h1>
         Header goes here
		</div>
        <div id="sidebar">
		Sidebar goes here
